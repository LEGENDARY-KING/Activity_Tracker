...
export declare class EnvironmentsClient {
    ...
    listEnvironments(request: protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest, options?: gax.CallOptions): Promise<[protos.google.cloud.dialogflow.v2.IEnvironment[], protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest | null, protos.google.cloud.dialogflow.v2.IListEnvironmentsResponse]>;
    listEnvironments(request: protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest, options: gax.CallOptions, callback: PaginationCallback<protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest, protos.google.cloud.dialogflow.v2.IListEnvironmentsResponse | null | undefined, protos.google.cloud.dialogflow.v2.IEnvironment>): void;
     ...
     */
    listEnvironmentsStream(request?: protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest, options?: gax.CallOptions): Transform;
    /**
     ...
     */
    listEnvironmentsAsync(request?: protos.google.cloud.dialogflow.v2.IListEnvironmentsRequest, options?: gax.CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2.IEnvironment>;
    /**
